...
| **SEC Financial Facts** ([`Equibles.Sec.FinancialFacts.*`](../../src/Equibles.Sec.FinancialFacts.Data)) | SEC EDGAR XBRL | `FinancialFact`, `FinancialConcept`, `FinancialFactDimension` (XBRL segment / scenario axis-member pairs) | `FinancialFactsScraperWorker` | `Equibles.Sec.FinancialFacts.Mcp` |
