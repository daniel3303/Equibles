...
- Foreign private issuers' 20-F, 6-K, and 40-F filings and amendments are now synced like domestic filings, and Form 5 and Form 5/A now feed the insider-transaction pipeline with the same supersession semantics as Forms 3/4.
