    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MarketCode = table.Column<string>(
                        type: "character varying(16)",
                        maxLength: 16,
                        nullable: false
                    ),
                    MarketName = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestSummary = table.Column<string>(
                        type: "character varying(512)",
                        maxLength: 512,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeasonalAdjustment = table.Column<string>(
                        type: "character varying(64)",
                        maxLength: 64,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateOrCountry = table.Column<string>(
                        type: "character varying(64)",
                        maxLength: 64,
                        nullable: true
                    ),
                    ...
                    OfficerTitle = table.Column<string>(
                        type: "character varying(128)",
                        maxLength: 128,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Form13FFileNumber = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: true
                    ),
                    CrdNumber = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarketCapitalization = table.Column<double>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdjustedClose = table.Column<decimal>(
                        type: "numeric(18,4)",
                        precision: 18,
                        scale: 4,
                        nullable: false
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityTitle = table.Column<string>(
                        type: "character varying(128)",
                        maxLength: 128,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleOfClass = table.Column<string>(
                        type: "character varying(128)",
                        maxLength: 128,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportingDate = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_HoldingManagerEntry",
                        x => new { x.InstitutionalHoldingId, x.Id }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(name: "IX_Errors_Seen", table: "Errors", column: "Seen");
        ...
        {
            migrationBuilder.DropTable(name: "CboePutCallRatio");

            migrationBuilder.DropTable(name: "CboeVixDaily");

            migrationBuilder.DropTable(name: "CftcPositionReport");

            migrationBuilder.DropTable(name: "CongressionalTrade");

            migrationBuilder.DropTable(name: "DailyShortVolume");

            migrationBuilder.DropTable(name: "DailyStockPrice");

            migrationBuilder.DropTable(name: "Embedding");

            migrationBuilder.DropTable(name: "Errors");

            migrationBuilder.DropTable(name: "FailToDeliver");

            migrationBuilder.DropTable(name: "FileContent");

            migrationBuilder.DropTable(name: "FredObservation");

            migrationBuilder.DropTable(name: "HoldingManagerEntry");

            migrationBuilder.DropTable(name: "InsiderTransaction");

            migrationBuilder.DropTable(name: "ShortInterest");

            migrationBuilder.DropTable(name: "CftcContract");

            migrationBuilder.DropTable(name: "CongressMember");

            migrationBuilder.DropTable(name: "Chunk");

            migrationBuilder.DropTable(name: "FredSeries");

            migrationBuilder.DropTable(name: "InstitutionalHolding");

            migrationBuilder.DropTable(name: "InsiderOwner");

            migrationBuilder.DropTable(name: "Document");

            migrationBuilder.DropTable(name: "InstitutionalHolder");

            migrationBuilder.DropTable(name: "CommonStock");

            migrationBuilder.DropTable(name: "File");

            migrationBuilder.DropTable(name: "Industry");
        }
    }
}
