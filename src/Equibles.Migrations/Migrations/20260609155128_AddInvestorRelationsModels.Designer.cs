...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Equibles.Finra.Data.Models.OffExchangeVolume", b =>
                {
                    ...
                    b.HasIndex("CommonStockId", "WeekStartDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("Equibles.Holdings.Data.Models.InstitutionalHolding", b =>
                {
                    ...
                    b.HasIndex("CommonStockId", "InstitutionalHolderId", "ReportDate", "ShareType", "OptionType", "FilingType")
                        .IsUnique();

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("CommonStockId", "InstitutionalHolderId", "ReportDate", "ShareType", "OptionType", "FilingType"), false);
            ...
            modelBuilder.Entity("Equibles.InsiderTrading.Data.Models.InsiderTransaction", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("TransactionDate"), new[] { "Shares", "PricePerShare", "IsPriceValid", "SecurityKind", "SecurityTitle" });
            ...
            modelBuilder.Entity("Equibles.InvestorRelations.Data.Models.EarningsCalendarEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CommonStockId", "ScheduledDate")
                        .IsUnique();

                    b.ToTable("EarningsCalendarEntry");
                });

            modelBuilder.Entity("Equibles.InvestorRelations.Data.Models.IrEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CommonStockId", "Title", "ScheduledDate")
                        .IsUnique();

                    b.ToTable("IrEvent");
                });

            modelBuilder.Entity("Equibles.InvestorRelations.Data.Models.IrNewsItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Equibles.Sec.FinancialFacts.Data.Models.FinancialFact", b =>
                {
                    ...
                    b.HasIndex("CommonStockId", "FinancialConceptId", "Unit", "PeriodStart", "PeriodEnd", "AccessionNumber")
                        .IsUnique();
