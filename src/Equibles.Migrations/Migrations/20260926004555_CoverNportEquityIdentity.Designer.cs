...
namespace Equibles.Migrations.Migrations
{
    ...
    [Migration("20260926004555_CoverNportEquityIdentity")]
    partial class CoverNportEquityIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Equibles.Holdings.Data.Models.HoldingLabelConvergenceState", b =>
                {
                    b.Property<Guid>("EquityIssuerId")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("ConvergedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("HoldingLabelConvergenceState");
                });
            ...
            modelBuilder.Entity("Equibles.Holdings.Data.Models.HoldingsImportFailure", b =>
                {
                    b.Property<string>("AccessionNumber")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.HasIndex("ResolvedAt", "NextAttemptAt");

                    b.ToTable("HoldingsImportFailure");
                });
            ...
            modelBuilder.Entity("Equibles.Holdings.Data.Models.InstitutionalHolding", b =>
                {
                    ...
                    b.HasIndex(new[] { "Id" }, "IX_InstitutionalHolding_ImplausibleDerivationRepair")
                        ...
                        .HasFilter("NOT \"ValuePending\" AND \"ShareType\" = 0 AND \"ValueSource\" <> 1 AND \"Shares\" > 0 AND \"Value\"::numeric > 1000000.0 * \"Shares\"::numeric")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true);

                    b.HasIndex(new[] { "EquityIssuerId", "Shares" }, "IX_InstitutionalHolding_ImpossiblePositionRepair")
            ...
            modelBuilder.Entity("Equibles.Sec.Data.Models.EsefOversizedReport", b =>
                {
                    b.Property<string>("Reference")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<int>("CeilingBytes")
                        .HasColumnType("integer");

                    b.Property<int?>("HtmlCeilingBytes")
                        .HasColumnType("integer");

                    b.Property<string>("HtmlSourceUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
            ...
            modelBuilder.Entity("Equibles.Sec.Data.Models.NportHolding", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Isin"), new[] { "NportFilingId" });

                    b.HasIndex("NportFilingId", "ValueUsd");

                    b.HasIndex("Isin", "Cusip", "Lei", "NportFilingId")
            ...
            modelBuilder.Entity("Equibles.CommonStocks.Data.Models.EquityIssuerPresentation", b =>
                {
                    ...
                    b.HasOne("Equibles.CommonStocks.Data.Models.EquityListing", "Listing")
                        .WithOne("Presentation")
                        .HasForeignKey("Equibles.CommonStocks.Data.Models.EquityIssuerPresentation", "EquityListingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
