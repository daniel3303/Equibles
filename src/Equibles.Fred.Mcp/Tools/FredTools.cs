...
public class FredTools {
    ...
    public Task<string> GetEconomicIndicator(
        ...
        }, _logger, "GetEconomicIndicator", $"seriesId: {seriesId}", ReportError);
    }
    ...
    public Task<string> GetLatestEconomicData(
        ...
        return McpToolExecutor.Execute(async () => {
            ...
            return result.ToString();
        }, _logger, "GetLatestEconomicData", $"category: {category}", ReportError);
    }
    ...
    public Task<string> SearchEconomicIndicators(
        ...
        return McpToolExecutor.Execute(async () => {
            ...
            return result.ToString();
        }, _logger, "SearchEconomicIndicators", $"query: {query}", ReportError);
    }
