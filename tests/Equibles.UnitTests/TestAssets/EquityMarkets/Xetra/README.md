...
- Every kept share is quoted in EUR on XETR; `Primary Market MIC Code` states the home venue (Vienna for the Austrian rows) and is evidence only, the FIRDS relevant-venue gate decides.
