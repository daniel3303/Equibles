...
public class FredSeriesRepositoryTests : IDisposable
{
    ...
    public async Task GetBySeriesId_DoesNotReturnOtherSeries()
    {
        ...
        result.Should().ContainSingle().Which.SeriesId.Should().Be("DFF");
    }
    ...
    public async Task GetByCategory_EmptyCategory_ReturnsEmpty()
    {
        _dbContext
            .Set<FredSeries>()
            .Add(CreateSeries("DFF", "Federal Funds", FredSeriesCategory.InterestRates));
        await _dbContext.SaveChangesAsync();
    ...
    public async Task GetByCategory_AllCategories_FiltersCorrectly()
    {
        ...
        _repository
            .GetByCategory(FredSeriesCategory.InterestRates)
            .ToList()
            .Should()
            .ContainSingle();
        ...
        _repository
            .GetByCategory(FredSeriesCategory.GdpAndOutput)
            .ToList()
            .Should()
            .ContainSingle();
    ...
    public async Task Search_ByTitle_FindsMatch()
    {
        ...
        result.Should().ContainSingle().Which.SeriesId.Should().Be("DGS10");
    }

    [Fact]
    public async Task Search_CaseInsensitive_FindsMatch()
    {
        _dbContext.Set<FredSeries>().Add(CreateSeries("DFF", "Federal Funds Effective Rate"));
        await _dbContext.SaveChangesAsync();
    ...
    {
        _dbContext.Set<FredSeries>().Add(CreateSeries("CPIAUCSL", "CPI for All Urban Consumers"));
        await _dbContext.SaveChangesAsync();
...
public class FredObservationRepositoryTests : IDisposable
{
    ...
    public async Task GetBySeries_DoesNotReturnOtherSeriesObservations()
    {
        ...
        result.Should().ContainSingle().Which.Value.Should().Be(5.33m);
    }
    ...
    public async Task GetBySeries_WithDateRange_FiltersCorrectly()
    {
        ...
        var result = _repository
            .GetBySeries(series, new DateOnly(2024, 1, 10), new DateOnly(2024, 2, 15))
            .ToList();
    ...
    public async Task GetBySeries_DateRangeInclusive_IncludesBoundaryDates()
    {
        ...
        var result = _repository
            .GetBySeries(series, new DateOnly(2024, 1, 1), new DateOnly(2024, 1, 31))
            .ToList();
    ...
    public async Task GetBySeries_DateRangeExcludesOtherSeries()
    {
        ...
        var result = _repository
            .GetBySeries(seriesA, new DateOnly(2024, 1, 1), new DateOnly(2024, 1, 31))
            .ToList();
    ...
    public async Task GetBySeries_DateRangeNoMatches_ReturnsEmpty()
    {
        ...
        _dbContext
            .Set<FredObservation>()
            .Add(CreateObservation(series.Id, new DateOnly(2024, 6, 1), 5.33m));
        await _dbContext.SaveChangesAsync();
    ...
    public async Task GetLatestPerSeries_ReturnsMostRecentPerSeries()
    {
        ...
        result
            .Should()
            .Contain(o => o.FredSeriesId == seriesA.Id && o.Date == new DateOnly(2024, 6, 1));
        result
            .Should()
            .Contain(o => o.FredSeriesId == seriesB.Id && o.Date == new DateOnly(2024, 9, 1));
    }
    ...
    public async Task GetLatestPerSeries_ExcludesNullValues()
    {
        ...
        result.Should().ContainSingle().Which.Date.Should().Be(new DateOnly(2024, 1, 1));
    }
    ...
    public async Task GetLatestPerSeries_SingleSeriesSingleObservation_ReturnsThatObservation()
    {
        ...
        _dbContext
            .Set<FredObservation>()
            .Add(CreateObservation(series.Id, new DateOnly(2024, 3, 15), 5.33m));
        await _dbContext.SaveChangesAsync();
