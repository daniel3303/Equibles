...
public class CftcToolsTests : ParadeDbMcpTestBase
{
    ...
    public CftcToolsTests(ParadeDbFixture fixture)
        : base(fixture) { }

    private static CftcContract CrudeOilContract() =>
        new()
        {
            MarketCode = "067651",
    ...
    private static CftcContract GoldContract() =>
        new()
        {
            MarketCode = "088691",
            MarketName = "GOLD",
    ...
    private static CftcPositionReport ReportFor(
        CftcContract contract,
        DateOnly date,
        long openInterest = 100_000,
        long commLong = 60_000,
        long commShort = 40_000,
        long nonCommLong = 30_000,
        long nonCommShort = 25_000,
        long nonCommSpreads = 5_000
    ) =>
        new()
        {
            CftcContract = contract,
            ...
            NonCommSpreads = nonCommSpreads,
            TotalRptLong = commLong + nonCommLong,
            TotalRptShort = commShort + nonCommShort,
            NonRptLong = 5_000,
            NonRptShort = 5_000,
        };
    ...
    public async Task GetCftcPositioning_ContractFoundNoReportsInRange_ReturnsNoReportsMessage()
    {
        ...
        var result = await Sut()
            .GetCftcPositioning("067651", startDate: "2026-04-01", endDate: "2026-04-30");
    ...
    public async Task GetCftcPositioning_RendersPositionRowsForRequestedContract()
    {
        ...
        var result = await Sut()
            .GetCftcPositioning("067651", startDate: "2026-03-01", endDate: "2026-04-30");
