...
public class CboePutCallRatioRepositoryTests : IDisposable
{
    ...
    public async Task GetByType_ReturnsEmpty_WhenTypeHasNoData()
    {
        _dbContext
            .Set<CboePutCallRatio>()
            .Add(CreateRatio(CboePutCallRatioType.Total, new DateOnly(2025, 1, 1)));
        await _dbContext.SaveChangesAsync();
    ...
    public async Task GetByType_DoesNotReturnOtherTypes()
    {
        ...
        result.Should().ContainSingle().Which.RatioType.Should().Be(CboePutCallRatioType.Equity);
    }
    ...
    public async Task GetByType_DateRangeExcludesOtherTypes()
    {
        ...
        result.Should().ContainSingle().Which.RatioType.Should().Be(CboePutCallRatioType.Total);
    }
    ...
    public async Task GetByType_DateRangeNoMatches_ReturnsEmpty()
    {
        _dbContext
            .Set<CboePutCallRatio>()
            .Add(CreateRatio(CboePutCallRatioType.Total, new DateOnly(2025, 6, 1)));
        await _dbContext.SaveChangesAsync();
    ...
    public async Task GetLatestDate_ReturnsMostRecentDateForType()
    {
        ...
        var result = await _repository
            .GetLatestDate(CboePutCallRatioType.Total)
            .FirstOrDefaultAsync();
    ...
    public async Task GetLatestPerType_ReturnsMostRecentPerType()
    {
        ...
        result
            .Should()
            .Contain(r =>
                r.RatioType == CboePutCallRatioType.Total && r.Date == new DateOnly(2025, 6, 1)
            );
        result
            .Should()
            .Contain(r =>
                r.RatioType == CboePutCallRatioType.Equity && r.Date == new DateOnly(2025, 9, 1)
            );
    }
    ...
    public async Task GetLatestPerType_SingleTypeSingleRecord_ReturnsThatRecord()
    {
        ...
        result.Should().ContainSingle().Which.PutCallRatio.Should().Be(1.25m);
    }
...
public class CboeVixDailyRepositoryTests : IDisposable
{
    ...
    public async Task GetByDateRange_ReturnsRecordsWithinRange()
    {
        ...
        var result = await _repository
            .GetByDateRange(new DateOnly(2025, 1, 10), new DateOnly(2025, 1, 25))
            .ToListAsync();
    ...
    public async Task GetByDateRange_IncludesBoundaryDates()
    {
        ...
        var result = await _repository
            .GetByDateRange(new DateOnly(2025, 1, 1), new DateOnly(2025, 1, 31))
            .ToListAsync();
    ...
    {
        var result = await _repository
            .GetByDateRange(new DateOnly(2025, 1, 1), new DateOnly(2025, 12, 31))
            .ToListAsync();
    ...
    public async Task GetByDateRange_SingleDay_ReturnsMatchingRecord()
    {
        ...
        result.Should().ContainSingle().Which.Close.Should().Be(22.50m);
    }
    ...
    {
        _dbContext.Set<CboeVixDaily>().Add(CreateVix(new DateOnly(2025, 3, 15)));
        await _dbContext.SaveChangesAsync();
    ...
    public async Task VixDaily_PersistsAllFieldValues()
    {
        ...
        var result = await _repository
            .GetByDateRange(new DateOnly(2025, 7, 15), new DateOnly(2025, 7, 15))
            .SingleAsync();
