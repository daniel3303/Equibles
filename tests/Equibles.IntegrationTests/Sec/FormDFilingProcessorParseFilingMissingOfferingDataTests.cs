...
public class FormDFilingProcessorParseFilingMissingOfferingDataTests
{
    // offeringData is Form D's required section. A submission that parses as valid XML but lacks it
    ...
    [Fact]
    public void ParseFiling_WellFormedXmlMissingOfferingData_ReturnsNull()
    {
        ...
        var root = XElement.Parse(
            "<edgarSubmission><primaryIssuer><entityName>Acme Capital LP</entityName></primaryIssuer></edgarSubmission>"
        );
